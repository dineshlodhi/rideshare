...
?>
  <h2 style="text-align:center">Search trips</h2>
  <form class="form-horizontal" method="POST" action="../views/search_similartrips.php">
    <div class="row">
    ...
    <div class="col-md-offset-2 col-md-4">
        ...
        <div class="form-group">
          <div class="col-sm-offset-5 col-sm-6">
            <button type="submit" id="submit" name="submit" class="btn btn-primary">Search trips</button>
          </div>
        </div>
